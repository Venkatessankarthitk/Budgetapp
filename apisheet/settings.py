"""
Django settings for apisheet project.
...
SECRET_KEY = '1y%9-p7%s0!cd_dja@#-#9b#ated$1v9ixni2znlg4#=m^%*zi'
...
WSGI_APPLICATION = 'apisheet.wsgi.application'
